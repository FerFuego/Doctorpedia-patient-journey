...
/***/ "./assets/js/app/usefull/class-changer.js":
/*!************************************************!*\
  !*** ./assets/js/app/usefull/class-changer.js ***!
  \************************************************/
  ...
  menuCurrentPageClass() {
    ...
    menus.forEach(menu => {
      ...
      menuItems.forEach(item => {
        ...
        const parentItem = item.closest('.menu-item-has-children'); //Unset classes and attr

        item.classList.remove('current-menu-item');
        item.classList.remove('current_page_item');
        link.removeAttribute('aria-current'); //Unset classes for parents and ancestors

        if (parentItem) {
          parentItem.classList.remove('current-menu-parent');
          parentItem.classList.remove('current_page_parent'); //Ancestors
        ...
        if (link.href == this.nextUrl) {
          ...
          item.classList.add('current_page_item'); //Add WP attr aria-current to link

          link.setAttribute('aria-current', 'page'); //Set classes for parents

          if (parentItem) {
            setTimeout(() => {
              //Parents
              parentItem.classList.add('current-menu-parent');
              parentItem.classList.add('current_page_parent'); //Ancestors
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ResetClasesBetweenPages);

/***/ }),

/***/ "./assets/js/app/usefull/force-reload-spa.js":
/*!***************************************************!*\
  !*** ./assets/js/app/usefull/force-reload-spa.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _barba_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @barba/core */ "./node_modules/@barba/core/dist/barba.mjs");
    ...
    xmlhttp.onreadystatechange = function () {
      if (xmlhttp.readyState == 4) {
        if (xmlhttp.status == 200) {
          //Res content
          try {
            this.permaliks = JSON.parse(xmlhttp.responseText); //Forced Links
            ...
            for (let i = 0; this.permaliks.length > i; i++) {
              ...
              links.forEach(link => {
                if (link.getAttribute('permalink') != '') {
                  ...
                  link.removeAttribute('href'); //Force reload page

                  link.addEventListener('click', () => {
                    _barba_core__WEBPACK_IMPORTED_MODULE_0__.default.force(link.getAttribute('permalink'));
                  });
                }
              });
            }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ForceReloadPages);

/***/ }),

/***/ "./assets/js/app/usefull/reset-scripts.js":
/*!************************************************!*\
  !*** ./assets/js/app/usefull/reset-scripts.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ResetScripts {
  ...
  reloadScripts() {
    ...
    document.body.appendChild(scripts); //Remove prev element
  ...
  reloadStyles() {
    ...
    document.head.appendChild(styles); //Remove prev element
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ResetScripts);

/***/ }),

/***/ "./assets/js/app/usefull/string-to-html.js":
/*!*************************************************!*\
  !*** ./assets/js/app/usefull/string-to-html.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (stringToHTML);
...
(() => {
/*!*********************************************!*\
  !*** ./assets/js/app/usefull/barba-init.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _barba_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @barba/core */ "./node_modules/@barba/core/dist/barba.mjs");
/* harmony import */ var _class_changer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./class-changer */ "./assets/js/app/usefull/class-changer.js");
/* harmony import */ var _string_to_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./string-to-html */ "./assets/js/app/usefull/string-to-html.js");
/* harmony import */ var _reset_scripts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reset-scripts */ "./assets/js/app/usefull/reset-scripts.js");
/* harmony import */ var _force_reload_spa__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./force-reload-spa */ "./assets/js/app/usefull/force-reload-spa.js");
//LIBRARIES
 //APP SCRIPTS
...
_barba_core__WEBPACK_IMPORTED_MODULE_0__.default.init({
  timeout: 10000,
  transitions: [{
  ...
  views: [{
    ...
    beforeEnter({
      ...
      const forceReload = new _force_reload_spa__WEBPACK_IMPORTED_MODULE_4__.default();
      forceReload.init();
    },
...
_barba_core__WEBPACK_IMPORTED_MODULE_0__.default.hooks.beforeEnter(data => {
  //Reset Scripts
  const nextPage = (0,_string_to_html__WEBPACK_IMPORTED_MODULE_2__.default)(data.next.html);
  const resetScripts = new _reset_scripts__WEBPACK_IMPORTED_MODULE_3__.default(nextPage);
  resetScripts.init(); //Reset clases

  const resetClasses = new _class_changer__WEBPACK_IMPORTED_MODULE_1__.default(nextPage, data.next.url.href);
  resetClasses.init();
});
})();
...
/******/ })()
;
//# sourceMappingURL=spa-webpage.min.js.map