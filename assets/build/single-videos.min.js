...
/***/ "./assets/js/app/modules/breadcrumbs.js":
/*!**********************************************!*\
  !*** ./assets/js/app/modules/breadcrumbs.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _usefull_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../usefull/api */ "./assets/js/app/usefull/api.js");
...
class Breadcrumbs {
  ...
  getPageHistory() {
    _usefull_api__WEBPACK_IMPORTED_MODULE_0__.default.get('/breadcrumbs/v1/history', {
      params: {
      ...
      if (response.data) {
        ...
        this.parent.setAttribute('href', response.data.permalink); //Archive
...
/***/ "./assets/js/app/modules/navbar.js":
/*!*****************************************!*\
  !*** ./assets/js/app/modules/navbar.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _usefull_jquery_prefix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../usefull/jquery-prefix */ "./assets/js/app/usefull/jquery-prefix.js");
 //PREFIX FOR JQUERY
  ...
  init() {
    window.addEventListener('load', () => {
      ...
      navbars.forEach(navbar => {
        ...
        const links = menu.querySelectorAll('.menu-item > a'); //Setting space from top of the page

        document.querySelector('body').style.paddingTop = brandingHeight + 'px'; //Toggler menu (Mobile)
        ...
        const firstUrl = window.location.href; //Sub menu dropdown

        itemWithSubmenu.forEach(item => {
          const subMenu = item.querySelector('.sub-menu');
          item.setAttribute('expanded', false); //Select Dropdown

          const link = item.querySelector('a'); //Remove URL from dropdown
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Navbar); //Close all dropdowns
  ...
  $(function () {
    ...
    if ($(window).width() > 1024) {
      ...
      $('.has-channels-menu').on('mouseover', function () {
        ...
        $('#js-dropdown-specialty-areas .big-menu-header__arrow-up').css({
          'display': 'none'
        });
        $('#js-dropdown-channels-menu .big-menu-header__arrow-up').css({
...
/***/ "./assets/js/app/modules/share_modal.js":
/*!**********************************************!*\
  !*** ./assets/js/app/modules/share_modal.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ShareModal {
  ...
  reload() {
    ...
    req.onload = function () {
      element.innerHTML = req.responseText; // Fix duplicate container
...
/***/ "./assets/js/app/modules/sidebar_videos.js":
/*!*************************************************!*\
  !*** ./assets/js/app/modules/sidebar_videos.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SidebarPlaylist);

/***/ }),

/***/ "./assets/js/app/usefull/animations.js":
/*!*********************************************!*\
  !*** ./assets/js/app/usefull/animations.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Api = axios__WEBPACK_IMPORTED_MODULE_0___default().create({
  ...
  headers: {
    'content-type': 'application/json' //'X-WP-Nonce': Doctorpedia.nonce
...
/***/ "./assets/js/app/usefull/jquery-prefix.js":
/*!************************************************!*\
  !*** ./assets/js/app/usefull/jquery-prefix.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/js/app/usefull/performance.js":
/*!**********************************************!*\
  !*** ./assets/js/app/usefull/performance.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/js/app/usefull/video-support.js":
/*!************************************************!*\
  !*** ./assets/js/app/usefull/video-support.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  previmeo(videoId, moduleId) {
    ...
    if (!document.querySelector('.vimeo-api')) {
      ...
      api.onload = function () {
        ...
        const player = new Vimeo.Player(moduleId, options); //Add video object
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VideoSupport);
...
var __webpack_exports__ = {};
/*!******************************************!*\
  !*** ./assets/js/pages/single-videos.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_usefull_performance__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app/usefull/performance */ "./assets/js/app/usefull/performance.js");
/* harmony import */ var _app_usefull_video_support__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../app/usefull/video-support */ "./assets/js/app/usefull/video-support.js");
/* harmony import */ var _app_modules_navbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app/modules/navbar */ "./assets/js/app/modules/navbar.js");
/* harmony import */ var _app_modules_share_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app/modules/share_modal */ "./assets/js/app/modules/share_modal.js");
/* harmony import */ var _app_modules_sidebar_videos__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app/modules/sidebar_videos */ "./assets/js/app/modules/sidebar_videos.js");
/* harmony import */ var _app_modules_breadcrumbs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../app/modules/breadcrumbs */ "./assets/js/app/modules/breadcrumbs.js");
/* harmony import */ var _app_usefull_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../app/usefull/animations */ "./assets/js/app/usefull/animations.js");
//Performance

_app_usefull_performance__WEBPACK_IMPORTED_MODULE_0__.default.init(); //Video support
...
const navbar = new _app_modules_navbar__WEBPACK_IMPORTED_MODULE_2__.default();
navbar.init();
const shareModal = new _app_modules_share_modal__WEBPACK_IMPORTED_MODULE_3__.default();
shareModal.init();
const sidebar = new _app_modules_sidebar_videos__WEBPACK_IMPORTED_MODULE_4__.default();
sidebar.init();
const videoPlayer = new _app_usefull_video_support__WEBPACK_IMPORTED_MODULE_1__.default();
const breadcrumbs = new _app_modules_breadcrumbs__WEBPACK_IMPORTED_MODULE_5__.default();
breadcrumbs.init(); //Page Animations


_app_usefull_animations__WEBPACK_IMPORTED_MODULE_6__.default.init();
})();
...
"use strict";
/*!**********************************************!*\
  !*** ./assets/scss/pages/single-videos.scss ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
...
/******/ })()
;
//# sourceMappingURL=single-videos.min.js.map